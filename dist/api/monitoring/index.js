...
router.get('/metrics', authenticate, async (req, res) => {
    try {
        ...
        query = query.gte('recorded_at', new Date(Date.now() - parsePeriod(period)).toISOString());
...
router.get('/health/:component', authenticate, async (req, res) => {
    try {
...
router.get('/provider-health', authenticate, async (req, res) => {
    try {
        const supabase = getSupabase();
        const orgId = req.organizationId;
