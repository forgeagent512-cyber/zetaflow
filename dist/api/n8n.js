...
export async function deployN8nWorkflowHandler(req, res) {
    try {
...
export async function updateN8nWorkflowHandler(req, res) {
    try {
...
export async function activateN8nWorkflowHandler(req, res) {
    try {
        const workflowId = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
...
export async function deactivateN8nWorkflowHandler(req, res) {
    try {
        const workflowId = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
...
export async function executeN8nWorkflowHandler(req, res) {
    try {
        const workflowId = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
...
export async function deleteN8nWorkflowHandler(req, res) {
    try {
        const workflowId = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
...
export async function getN8nWorkflowHandler(req, res) {
    try {
        const workflowId = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
...
export async function n8nHealthHandler(req, res) {
    try {
...
export async function syncN8nCredentialsHandler(req, res) {
    try {
