...
router.post('/validate-input', authenticate, async (req, res) => {
    try {
...
router.post('/detect-injection', authenticate, async (req, res) => {
    try {
...
router.post('/decrypt', authenticate, async (_req, res) => {
