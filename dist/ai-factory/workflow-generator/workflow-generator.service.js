...
export class WorkflowGeneratorService {
    ...
    serializer;
    deploymentPlanner;
    constructor(repository, nodeBuilder = new NodeBuilder(), connectionBuilder = new ConnectionBuilder(), expressionBuilder = new ExpressionBuilder(), credentialBuilder = new CredentialBuilder(), validator = new WorkflowValidator(), serializer = new WorkflowSerializer(), deploymentPlanner = new DeploymentPlanner()) {
    ...
    async generate(input) {
        ...
        const workflowDefinition = {
            ...
            variables: {
                ...
                employeeName: validated.employee?.name ?? 'operator'
            },
            metadata: {
        ...
        const status = existing ? 'reused' : 'active';
