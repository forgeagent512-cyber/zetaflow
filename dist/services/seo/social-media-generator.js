...
export class SocialMediaGenerator {
    ...
    async generateLinkedInPost(topic, tone) {
...
Return only the post content:`;
    ...
    async generateTwitterPost(topic) {
...
Return only the post content:`;
    ...
    async generateFacebookPost(topic) {
...
Return only the post content:`;
    ...
    async generateInstagramPost(topic) {
...
Return JSON:
{
  ...
  "hashtags": ["string"] (10-15 relevant hashtags including niche tags)
    ...
    async generateThreadsPost(topic) {
...
Return only the post content:`;
    ...
    async generateRedditPost(topic, subreddit) {
...
[body]`;
    ...
    async generateMediumArticle(topic) {
