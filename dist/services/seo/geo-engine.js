...
export class GEOEngine {
    ...
    async buildKnowledgeGraph(orgId, entities) {
        const supabase = this.getSupabase();
...
Return only the optimized content:`;
    ...
    async generateEntityPages(orgId, entities) {
        const pages = [];
...
Return JSON:
{
  ...
  "suggestedInternalLinks": ["string"]
    ...
    async generateContextPages(orgId, topic) {
...
Return JSON:
{
  ...
  "schemaType": "Article"
    ...
    async createTopicClusters(orgId, topics) {
        const clusters = [];
