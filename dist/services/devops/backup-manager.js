...
export class BackupManager {
    ...
    async processBackup(id, orgId, includes) {
        const supabase = getSupabase();
        try {
            const backupData = {};
    ...
    async scheduleBackup(orgId, config) {
        const supabase = getSupabase();
