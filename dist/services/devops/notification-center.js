...
export class NotificationCenter {
    async sendNotification(orgId, userId, data) {
    ...
    async dispatchToChannel(data, orgId) {
        try {
            switch (data.channel) {
                case 'email':
    ...
    async getNotifications(orgId, userId) {
        const supabase = getSupabase();
    ...
    async configureChannel(orgId, channel, config) {
        const supabase = getSupabase();
    ...
    async sendEmailViaChannel(orgId, message) {
        const supabase = getSupabase();
    ...
    async sendSlackViaChannel(orgId, message) {
        const supabase = getSupabase();
    ...
    async sendDiscordViaChannel(orgId, message) {
        const supabase = getSupabase();
    ...
    async sendWhatsAppViaChannel(orgId, message) {
        const supabase = getSupabase();
    ...
    async sendTelegramViaChannel(orgId, message) {
        const supabase = getSupabase();
    ...
    async sendWebhookViaChannel(orgId, data) {
        const supabase = getSupabase();
