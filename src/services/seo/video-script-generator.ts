...
export class VideoScriptGenerator {
  ...
  async generateYouTubeScript(topic: string, duration?: number): Promise<any> {
...
Return JSON:
{
  ...
  async generateTikTokScript(topic: string): Promise<any> {
...
Return JSON:
{
  ...
  async generateReelScript(topic: string): Promise<any> {
...
Return JSON:
{
  ...
  async generateShortsScript(topic: string): Promise<any> {
...
Return JSON:
{
  ...
  async generateWebinarScript(topic: string, duration?: number): Promise<any> {
...
Return JSON:
{
  ...
  async generateDemoScript(product: any): Promise<any> {
