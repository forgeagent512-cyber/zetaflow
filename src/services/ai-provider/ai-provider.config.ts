import type { AIProviderConfig } from './ai-provider.types.js';
...
export function getAnthropicConfig(): AIProviderConfig {
  return getEnvConfig(
    'ANTHROPIC_API_KEY',
    'ANTHROPIC_BASE_URL',
...
export function validateOpenRouterConfig(): AIProviderConfig {
