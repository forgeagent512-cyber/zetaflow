import type { ModelCost } from './ai-provider.types.js';
...
export function calculateCost(model: string, promptTokens: number, completionTokens: number): { totalCost: number; costPerToken: number } {
...
export function estimateCost(model: string, promptText: string): { inputTokens: number; outputTokens: number; estimatedCost: number } {
