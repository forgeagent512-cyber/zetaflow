...
export class AuditService {
  async log(supabase: SupabaseClient, entry: AuditEntry): Promise<void> {
    try {
  ...
  async query(supabase: SupabaseClient, options: { organizationId?: string; userId?: string; action?: string; limit?: number; offset?: number }) {
