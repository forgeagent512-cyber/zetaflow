...
export interface GeminiEmployeeGeneratorConfig {
  apiKey: string;
  model?: string;
  endpoint?: string;
}
...
export class GeminiEmployeeGenerator {
  constructor(private readonly config: GeminiEmployeeGeneratorConfig) {}

  async generate(input: EmployeeGeneratorInputDto): Promise<EmployeeGeneratorOutputDto> {
