...
export class PromptBuilder {
  build(input: PromptGeneratorInputDto, model: string): PromptPackageDto {
  ...
  private stringValue(source: Record<string, unknown> | undefined, key: string): string | undefined {
