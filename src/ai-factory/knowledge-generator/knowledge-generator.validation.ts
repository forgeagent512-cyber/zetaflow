...
export function validateKnowledgeGeneratorInput(input: Record<string, unknown>): ValidatedKnowledgeInput {
  ...
  const files: Array<{ name: string; content?: string; mimeType?: string }> = rawFiles
