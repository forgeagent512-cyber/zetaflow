...
router.get('/white-label', authenticate, async (req: Request, res: Response) => {
  try {
...
router.put('/white-label', authenticate, async (req: Request, res: Response) => {
  try {
    const supabase = getSupabase();
    const orgId = req.organizationId!;
...
router.post('/white-label/verify-domain', authenticate, async (req: Request, res: Response) => {
  try {
