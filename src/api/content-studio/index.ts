...
router.post('/landing-page', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/blog-post', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/article', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/case-study', authenticate, async (req: Request, res: Response) => {
  try {
    const data = req.body;
    if (!data) {
...
router.post('/sales-page', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/whitepaper', authenticate, async (req: Request, res: Response) => {
  try {
