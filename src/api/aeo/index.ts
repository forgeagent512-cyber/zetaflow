...
router.post('/how-to', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/comparison', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/glossary', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/featured-snippet', authenticate, async (req: Request, res: Response) => {
  try {
