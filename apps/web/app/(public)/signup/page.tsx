...
export default function SignupPage() {
  ...
  const {
    ...
    defaultValues: { fullName: "", email: "", password: "", organizationName: "", agreeTerms: true },
  });
      ...
      <div className="min-h-[90vh] flex items-center justify-center px-6 py-24">
        <div className="w-full max-w-sm mx-auto">
          <AnimatedSection className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">Start building your AI workforce</p>
          </AnimatedSection>

          <AnimatedSection delay={0.1} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="w-full" onClick={googleLogin} disabled={isSubmitting}>
              ...
              <Button variant="outline" className="w-full" onClick={githubLogin} disabled={isSubmitting}>
